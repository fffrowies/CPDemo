...
public final class NationContract {
    ...
    public static final String CONTENT_AUTHORITY = "com.fffrowies.cpdemo.data.NationProvider";

    // BASE_CONTENT_URI: content://com.fffrowies.cpdemo.data.NationProvider
	...
	public static final class NationEntry implements BaseColumns {
	    ...
	    // CONTENT_URI: content://com.fffrowies.cpdemo.data.NationProvider/countries
